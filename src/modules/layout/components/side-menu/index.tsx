...
const SideMenuItems = {
  // GenEdUSA: "https://www.genedusa.com/",
  Store: "/",
  Products: "/store",
  // Search: "",
  Account: "/account",
                ...
                <Popover.Panel className="flex flex-col absolute w-1/3 2xl:w-1/4 h-[calc(100vh-1rem)] z-30 inset-x-0 text-sm text-ui-fg-on-color m-2 backdrop-blur-2xl">
                  <div className="flex flex-col h-full bg-[rgba(3,7,18,0.5)] rounded-rounded justify-between p-6">
                    <div className="flex flex-col">
                      <div className="flex flex-row justify-end" id="xmark">
                      ...
                      <div>
                        <Link
                          ...
                          className="text-3xl font-semibold leading-10 hover:text-ui-fg-disabled flex flex-row gap-1 items-center"
                          onClick={close}
                        >
                          <img
                            src="/logo.png"
                    ...
                    <div className="flex flex-col gap-y-6">
                      ...
                      <Text className="flex justify-between txt-compact-small">
                        © {new Date().getFullYear()} GenEdUSA. All rights
                        reserved.
                      </Text>
                    </div>
                  </div>
